<?php 
    ...
    $key = rand(100, 100000);
	$password = $nic . '@' . $key;
	if(mysqli_query($db_con,"UPDATE `student` SET `password`  = '$password' WHERE `sId`='$sId';")){
		...
		echo '<a class="btn btn-xs btn-warning" href="admin.php?page=password-reset&reset=success">OK</a>';
	}else{
