    ...
    while ($result = mysqli_fetch_array($query)) { ?>
      <tr>
        ...
        echo '<td>' . $i . '</td>
          ...
          <td>
            <a class="btn btn-xs btn-warning" href="admin.php?page=edit-student&sId=' . base64_encode($result['sId']) . '&photo=' . base64_encode($result['photo']) . '">
              <i class="fa fa-edit"></i></a>

             &nbsp; <a class="btn btn-xs btn-danger" onclick="javascript:confirmationDelete($(this));return false;" href="admin.php?page=delete-student&sId=' . base64_encode($result['sId']) . '&photo=' . base64_encode($result['photo']) . '">
